...
from tasks import task_processing
...
def check_answer():
    ans = request.json
    return {"answer": task_processing.check_submit(ans.get('user'), ans.get('task'), ans.get('solution'), ans.get('condition'))}


@app.route("/tasks", methods=['GET'])
def ret_tasks():
    return task_processing.get_tasks()
